...
These issues have so far not been researched in a decentralized context. There exist numerous papers describing such problems in centralized grid computing infrastructures. 
